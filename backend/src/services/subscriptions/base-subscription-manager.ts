...
export interface WebSocketMessage {
  ...
  type: 'subscription' | 'unsubscription' | 'heartbeat' | 'data' | 'error' | 'diagnostics' | 'general_stats_update' | 'dashboard_layout_update' | 'gateway_status_update' | 'scope_update' | 'command_queue_update' | 'logs_update' | 'units_update' | 'battery_status_update' | 'device_status_update' | 'fms_sync_status_update' | 'fms_sync_progress_update' | 'dev_notifications_update' | 'notifications_update' | 'notification_created' | 'notification_read' | 'notification_deleted' | 'notifications_batch_read' | 'notifications_batch_hidden' | 'notifications_count_update' | 'activity_update' | 'activity_new' | 'access_codes_update' | 'access_code_push_state_update' | 'key_sharing_update' | 'firmware_push_progress_update' | 'gateway_recovery_progress_update' | 'gateway_recovery_status_update' | 'gateway_telemetry_log_update' | 'gateway_device_sync_log_update' | 'access_session_trace_update' | 'app_event';
