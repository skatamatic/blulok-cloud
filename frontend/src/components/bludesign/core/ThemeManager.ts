...
const BUILTIN_THEMES: Theme[] = [
  ...
  {
    id: 'theme-storage-units',
    name: 'Storage Units',
    description: 'Classic white storage units with blue sheet-metal roofs and roll-up doors',
    categorySkins: {
      [AssetCategory.STORAGE_UNIT]: 'skin-unit-white-blue',
      [AssetCategory.GATE]: 'skin-gate-default',
    ...
    environment: {
      grass: { color: '#3d7a3d', metalness: 0.0, roughness: 0.95 },
      pavement: { color: '#565e66', metalness: 0.03, roughness: 0.85 },
      gravel: { color: '#a8957a', metalness: 0.05, roughness: 0.95 },
    },
    isBuiltin: true,
    createdAt: new Date(),
