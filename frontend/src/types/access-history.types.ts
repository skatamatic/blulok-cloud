export interface AccessLog {
  ...
  action: 'unlock' | 'lock' | 'access_granted' | 'access_denied' | 'unlock_attempt' | 'lock_attempt' | 'manual_override' | 'admin_remote_open' | 'keypad_attempt' |
          ...
          'door_open' | 'door_close' | 'gate_open' | 'gate_close' | 'elevator_call' | 'elevator_access' |
  ...
  denial_reason?: 'invalid_credential' | 'out_of_schedule' | 'system_error' | 'device_offline' |
                  ...
                  'route_pass_expired' | 'route_pass_invalid_signature' | 'route_pass_wrong_lock' | 'unknown_error' | 'timeout' | 'settlement_mismatch' | 'other';
  reason?: string;
